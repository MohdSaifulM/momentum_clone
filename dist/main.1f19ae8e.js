...
var backgroundURL = "https://api.unsplash.com/photos/AYFgiNAjwd4?client_id=AicRuPticACIsZoI7dAnlmWXIw7Vxn7dyKeIzKsAHbA";
var weatherURL = "http://api.openweathermap.org/data/2.5/weather?q=Singapore&units=metric&appid=da5c075ec9254430fe750c6299c322bf";
var quoteURL = "https://api.forismatic.com/api/1.0/?method=getQuote&lang=en&format=json";
axios.get(backgroundURL).then(function (result) {
  console.log(result.data.urls.regular); //decided to use just one photo instead of random because some of the photos does not look too good
  ...
  document.querySelector(".bg").style.content = "url(\"".concat(result.data.urls.raw, "\")");
}).catch(function (error) {
  console.log(error);
});
axios.get(weatherURL).then(function (result) {
  console.log(result.data.name);
  var html = "".concat(Math.floor(result.data.main.temp), "\xB0C </br> ").concat(result.data.name);
  document.querySelector(".weather").innerHTML = html;
}).catch(function (error) {
  console.log(error);
});
axios.get(quoteURL).then(function (result) {
  console.log(result.data);
  var html = "<div class=\"font-italic\">".concat(result.data.quoteText, "</div> ~ ").concat(result.data.quoteAuthor);
  document.querySelector(".quotes").innerHTML = html;
}).catch(function (error) {
  console.log(error);
});
setInterval(function () {
  document.querySelector(".time").innerHTML = "".concat(moment().format("h:mm:ss a"), " </br> <h1>Good day, Saif</h1>");
}, 1000);
},{"axios":"node_modules/axios/index.js","moment":"node_modules/moment/moment.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
